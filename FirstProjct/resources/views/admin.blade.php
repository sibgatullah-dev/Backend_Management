        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('my.task') }}" class="nav-link">
              <i class="link-icon fa-regular fa-rectangle-list"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#catagoryComponents" role="button" aria-expanded="false" aria-controls="catagoryComponents">
                <i class="link-icon fa-solid fa-layer-group"></i>
                <span class="link-title">Categories</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
              </a>
              <div class="collapse" id="catagoryComponents">
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-es" title="es" id="es"></i> <span class="ml-1"> Spanish </span></a>
						...
						<li class="nav-item dropdown nav-profile">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<img src="{{ asset('uploads/user') }}/{{ Auth::user()->picture }}" alt="profile">
							</a>
							<div class="dropdown-menu" aria-labelledby="profileDropdown">
								<div class="dropdown-header d-flex flex-column align-items-center">
									<div class="figure mb-3">
										<img src="{{ asset('uploads/user') }}/{{ Auth::user()->picture }}" alt="">
									</div>
